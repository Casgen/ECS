...
protected:
    ...
    std::string GetName() override { return {"MouseButtonEvent - Button: " + std::to_string(m_KeyCode)}; }
...
public:
    ...
    std::string GetName() override { return {"MouseButtonPressedEvent - Button: " + std::to_string(m_KeyCode)}; }
};
...
public:
    ...
    std::string GetName() override { return {"MouseButtonReleasedEvent - Button: " + std::to_string(m_KeyCode)}; }
};
...
public:
    ...
    std::string GetName() override { return {"MouseButtonRepeatedEvent - Button: " + std::to_string(m_KeyCode)}; }
};
...
public:
    ...
    {
        return {"MouseMovec X: " + std::to_string(m_Pos.x) + " Y:" + std::to_string(m_Pos.y)};
    }
...
public:
    ...
    {
        return {
            "MouseButtonScrolled X Offset: " + std::to_string(m_XOffset) +
